        ...
        <el-row :gutter="10">
          <el-col :span="10">
            <el-form-item label="姓名：">
              <el-input :disabled="iptDisabled"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="10">
            <el-form-item label="性别：">
              <el-date-picker type="date" placeholder="选择日期" :disabled="iptDisabled"></el-date-picker>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row :gutter="10">
          <el-col :span="10">
            <el-form-item label="出生年月：">
              <el-select v-model="value" placeholder="请输入关键词" :disabled="iptDisabled">
