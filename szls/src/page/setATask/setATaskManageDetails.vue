<template>
  <div class="setATaskDetails">
    <el-steps :active="active" align-center style="padding-top:15px;">
      <el-step title="新增任务" icon="el-icon-edit"> description>11</el-step>
      <el-step title="检查组选择" description>2222</el-step>
      <el-step title="规避" description></el-step>
      <el-step title="检查组取得" description></el-step>
    </el-steps>
...
<script>
import { getDictionaryList } from "../../api/setTask/index.js";
export default {
  components: {},
  data() {
    return {
...
.setATaskDetails >>> .el-step__title {
  font-size: 14px;
}
</style>
