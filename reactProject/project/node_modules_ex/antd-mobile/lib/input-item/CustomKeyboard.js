...
var KeyboardItem = (exports.KeyboardItem = (function(_React$Component) {
  ...
  function KeyboardItem() {
    ...
    return (0, _possibleConstructorReturn3['default'])(
      this,
      (KeyboardItem.__proto__ || Object.getPrototypeOf(KeyboardItem)).apply(this, arguments)
    )
  }
      ...
      value: function render() {
        ...
        return _react2['default'].createElement(
          ...
          _react2['default'].createElement(
            ...
            children,
            iconOnly && _react2['default'].createElement('i', { className: 'sr-only' }, label)
          )
        )
      }
    }
...
var CustomKeyboard = (function(_React$Component2) {
  ...
  function CustomKeyboard() {
    ...
    var _this2 = (0, _possibleConstructorReturn3['default'])(
      this,
      (CustomKeyboard.__proto__ || Object.getPrototypeOf(CustomKeyboard)).apply(this, arguments)
    )
  ...
  ;(0, _createClass3['default'])(CustomKeyboard, [
    {
      ...
      value: function render() {
        ...
        var wrapperCls = (0, _classnames2['default'])(
          prefixCls + '-wrapper',
        ...
        return _react2['default'].createElement(
          ...
          header && _react2['default'].cloneElement(header),
          _react2['default'].createElement(
            'table',
            null,
            _react2['default'].createElement(
              ...
              _react2['default'].createElement(
                ...
                _react2['default'].createElement(
                  KeyboardItem,
                  (0, _extends3['default'])(
                    { className: 'keyboard-delete', onClick: this.onKeyboardClick },
