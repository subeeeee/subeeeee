  ...
  <div class="public distributionDispose ">
    ...
    <el-row class="tableInfo module_margin_bottom">
      ...
      <el-col  class="table_tr" :span="24">
        ...
        <el-col :span="8" :offset="1" class="table_td" style="text-align:left">
          <el-col :span="14" :offset="1"><el-input size="small" @keyup.native="clearSpeace(arrivalInfoVo.warrantNumber)" maxlength="50" v-model="arrivalInfoVo.warrantNumber"></el-input></el-col>
        </el-col>
      </el-col>
      <el-col :span="24" class="table_tr">
    ...
    <el-row class="tableInfo module_margin_bottom" >
      ...
      <el-col :span="24" class="table_tr textarea_module" v-if="radio == '0'">
        ...
        <el-col :span="20" class="textareawrap"><div class="textarea"><textarea disabled :rows="10" v-model="arrivalInfoVo.fialReason" placeholder=" 请填写备注信息。" maxlength="2000"></textarea></div></el-col>
      </el-col>
      <el-col :span="24" class="table_tr textarea_module" >
        <el-col :span="4" class="table_td textarea_title">备注信息</el-col>
        <el-col :span="20" class="textareawrap"><div class="textarea"><textarea disabled :rows="10" v-model="arrivalInfoVo.remark"  placeholder=" 请填写备注信息。" maxlength="2000"></textarea></div></el-col>
      </el-col>
    </el-row>
...
<script>
  ...
  export default {
    ...
    methods: {
      clearSpeace(str){
        this.arrivalInfoVo.warrantNumber = this._utils.clearSpeace(str)
      },
      clickBtn(type){
        let params = {
          result:this.radio,
          ...
          warrantNumber:this.arrivalInfoVo.warrantNumber,
        };
        ...
        if(!this.arrivalInfoVo.warrantNumber){
          this.$message({
            type:'warning',
            message:'请输入抵押登记权证编号',
            duration:1500,
        ...
        this.$confirm('确认提交进抵登记？提交后所有信息将进入放款风控环节，所提交信息有误将影响到放款审批', '提示', {
          ...
          $.post(this._path + "/busArrivalInfo/busArrivalInfoAttach",params,(res)=>{
            loading.close();
