<template>
  <div class="public distributionDispose ">
    ...
    <picModule v-if="radio == '1'" :bussNo="$route.query.bussNo" dataType="2" taskType="272" :details="false"/>
    <br />
    <div class="show_list_title" v-if="radio == '1'">
      <h3><img src="../../assets/message.png" class="listTitleImg"><span>他证影像</span></h3>
    </div>
    <el-row class="tableInfo module_margin_bottom" v-if="radio == '1'">
      <el-col  class="table_tr" :span="24">
        <el-col :span="4" class="table_td">抵押登记权证编号</el-col>
        <el-col :span="8" :offset="1" class="table_td" style="text-align:left">
          {{arrivalInfoVo.warrantNumber}}&nbsp;
        </el-col>
      </el-col>
    </el-row>
    <picModule v-if="radio == '1'" :bussNo="$route.query.bussNo" dataType="3" taskType="272" :details="false"/>
    <br />
    <el-row class="tableInfo module_margin_bottom" >
      <el-col :span="24" class="table_tr textarea_module" v-if="radio == '0'">
        ...
        <el-col :span="20" class="textareawrap"><div class="textarea"><textarea :rows="10" disabled v-model="arrivalInfoVo.fialReason" placeholder=" 请填写备注信息。" maxlength="2000"></textarea></div></el-col>
      </el-col>
      <el-col :span="24" class="table_tr textarea_module" >
        <el-col :span="4" class="table_td textarea_title">备注信息</el-col>
        <el-col :span="20" class="textareawrap"><div class="textarea"><textarea :rows="10" disabled v-model="arrivalInfoVo.remark"  placeholder=" 请填写备注信息。" maxlength="2000"></textarea></div></el-col>
      </el-col>
    </el-row>
