<template>
  <div class="contractPreparingList public">
    ...
    <picModule dataType="1" :bussNo="$route.query.bussNo" taskType='232' :details="false"/>
    <!--图片-->
    ...
    <el-col :offset="11" :span="2"><el-button class="bottom_condition_btn" size="small" @click="btnClick">返回</el-button></el-col>
  </div>
</template>
    ...
    beforeCreate(){
      ...
      $.post(this._path+ "/busTrialInfo/busTrialInfo",{id:this.$route.query.id},(res)=>{
        if(res.resultCode == '0000'){
          this.remark = res.data.busTrialInfoVo.remark
        }else{
