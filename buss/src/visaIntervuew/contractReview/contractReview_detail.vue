    ...
    <el-row class="module_margin_bottom wz_table_border doNotChange table_height">
      <el-col :span="24" class="borrowerInfTr">
        ...
        <el-col :span="16" class="borrowerInfTd">
          <el-radio disabled class="radio" v-model="conclusion" label="1" >可公证</el-radio>
          <el-radio disabled class="radio" v-model="conclusion" label="0" >拒单</el-radio>
        </el-col>
      </el-col>
    </el-row>
      ...
      <el-col :span="24" class="table_tr">
        <el-col :span="24" class="table_tr" v-show="conclusion == '0'">
          <el-col :span="24" class="table_tr textarea_module" >
            ...
            <el-col :span="20" class="textareawrap"><div class="textarea"><textarea :rows="10" disabled v-model="refusalReason" placeholder="请说明拒绝原因" maxlength="2000"></textarea></div></el-col>
          </el-col>
        </el-col>
        <el-col :span="24" class="table_tr" v-show="conclusion == '1'">
          <el-col :span="24" class="table_tr textarea_module" >
            <el-col :span="4" class="table_td textarea_title">备注</el-col>
            <el-col :span="20" class="textareawrap"><div class="textarea"><textarea :rows="10" disabled v-model="remark" placeholder="请输入备注信息" maxlength="2000"></textarea></div></el-col>
          </el-col>
        </el-col>
      </el-col>
    </el-row>

    <picModule dataType="1"  :bussNo="$route.query.bussNo" taskType='212' :details="false"/>
...
<script>
  export default {
    ...
    methods: {
      btnClick (type) {
        this.$router.push({path:'/contractReviewList'})
      }
    },
    beforeCreate () {
