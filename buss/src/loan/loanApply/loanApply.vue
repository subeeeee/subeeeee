<template>
  <div class="firstCheck public">
    ...
    <el-row class="module_margin_bottom tableInfo">
      ...
      <!--<el-col :span="24" class="table_tr">
        <el-col :span="24" class="table_tr textarea_module" v-show="isFinalAgree == '1'">
      ...
      <el-col :span="24" class="table_tr">
        <el-col :span="24" class="table_tr textarea_module" v-show="isFinalAgree == '0'">
      ...
      <el-col :span="24" class="table_tr">
        <el-col :span="24" class="table_tr textarea_module" >
          ...
          <el-col :span="20" class="textareawrap"><div class="textarea"><textarea :rows="10" v-model="applyConclusion" maxlength="2000"></textarea></div></el-col>
        </el-col>
      </el-col>
      <!-- <el-col :span="24" class="table_tr">
         <el-col :span="24" class="table_tr textarea_module" >
           <el-col :span="4" class="table_td textarea_title">拒绝原因<i class="importent">*</i></el-col>
           <el-col :span="20" class="textareawrap"><div class="textarea"><textarea :rows="10" v-model="reject" maxlength="2000"></textarea></div></el-col>
         </el-col>
       </el-col>-->
    </el-row>
    <div class="show_list_title">
    ...
    <picModule :bussNo="$route.query.bussNo" dataType="1" taskType="314" />
  ...
  export default {
    ...
    methods: {
      btnClick (type) {
        let params = {
          ...
          firstConclusion:this.loanFirstCheckOpinion,
        ...
        if(type == 'submit'){
          ...
          if(!this.applyConclusion){
            this.$message.warning('请填写放款申请意见');
            return
          }
          this.$confirm('是否提交放款确认！', '提示', {
            ...
            $.post(this._path + '/busLoanApplyInfo/insertAssessSubmit',params,res=>{
              loading.close();
        ...
        if(type == "save"){
          ...
          $.post(this._path + '/busLoanApplyInfo/insertLoanApplyInfoSave',params,res=>{
            loading.close();
            if(res.resultCode == '0000'){
              this.$message({
                type:'success',
    ...
    created () {
      ...
      $.post(this._path + "/busLoanApplyInfo/selectLoanApplyInfoByBusNo",{bussNo:this.$route.query.bussNo},res=>{
        if (res.resultCode == "0000") {
          if(res.data.busLoanApplyInfoVo.isAgree){
      ...
      $.post(this._path + '/visaInterview/selectContractPreInfoByBussNo',{bussNo:this.$route.query.bussNo},res=>{
        if (res.resultCode == "0000") {
          ...
          // this.riskReault = res.data.contractPreInfoVos.approvalConclusion;
