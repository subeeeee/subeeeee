<template>
  <div class="firstCheck public">
    ...
    <picModule class="module_margin_bottom" :bussNo="$route.query.bussNo" dataType="2" taskType="315"/>
    <el-row class="module_margin_bottom tableInfo">
      <el-col :span="24" class="table_tr">
        <el-col :span="24" class="table_tr textarea_module" >
          <el-col :span="4" class="table_td textarea_title">放款意见</el-col>
          <el-col :span="20" class="textareawrap"><div class="textarea"><textarea :rows="10" v-model="loanOpinion" placeholder="请填写放款意见。" maxlength="2000"></textarea></div></el-col>
        </el-col>
      </el-col>
    </el-row>
  ...
  export default {
    ...
    methods: {
      ...
      submit (type,msg) {
        let params = {
          bussNo:this.$route.query.bussNo,
          companyAcctName:this.capitalAcctName,
          companyAcctNo:this.capitalAcctNo,
          companyAcctOpenbank:this.capitalAcctOpenbank,
          saveOrSubmit:type,
          loanOpinion:this.loanOpinion
        }
        $.post(this._path + '/loanFinance/LoanFinanceInfoSaveOrSubmit',params,res=>{
          if (res.resultCode == "0000"){
            this.$message({
              type:'success',
              message:msg,
