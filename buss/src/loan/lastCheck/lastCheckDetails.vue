      ...
      <el-col :span="24" class="table_tr">
        ...
        <el-col :span="8" class="table_td">
          <el-col :span="20" class="font_left" :offset="1">
            ...
            <!--<el-input size="small"  v-model="dealBusNotarizationVo.account"></el-input>-->
          </el-col>
      ...
      <el-col :span="24" class="table_tr">
        ...
        <el-col :span="8" class="table_td">
          <el-col :span="20" class="font_left" :offset="1">
            ...
            <!--<el-input size="small"  :maxlength="40"  v-model="dealBusNotarizationVo.accBank"></el-input>-->
          </el-col>
        </el-col>
        ...
        <el-col :span="8" class="table_td">
          <el-col :span="20" class="font_left" :offset="1">
            ...
            <!--<el-input size="small"  v-model="dealBusNotarizationVo.accMobile"></el-input>-->
          </el-col>
        </el-col>
      </el-col>
      <el-col :span="24" class="table_tr">
        ...
        <el-col :span="8" class="table_td">
          <el-col :span="20" class="font_left" :offset="1">
            ...
            <!--<el-input size="small" v-model="dealBusNotarizationVo.useMobile"></el-input>-->
          </el-col>
        </el-col>
        ...
        <el-col :span="8" class="table_td">
          <el-col :span="20" class="font_left" :offset="1">
            ...
            <!--<el-input size="small"  maxlength="50" v-model="loanNumber"></el-input>-->
          </el-col>
        </el-col>
      </el-col>
      <el-col :span="24" class="table_tr">
        ...
        <el-col :span="8" class="table_td">
          <el-col :span="20" class="font_left" :offset="1">
            ...
            <!--<el-input size="small" @keyup.native="clearSpeace('mortgageNumber')" maxlength="50" v-model="mortgageNumber"></el-input>-->
          </el-col>
        </el-col>
        ...
        <el-col :span="8" class="table_td">
          <el-col :span="20" class="font_left" :offset="1">
            ...
            <!--<el-input size="small" @keyup.native="clearSpeace('transferNumber')" maxlength="50" v-model="transferNumber"></el-input>-->
          </el-col>
        </el-col>
      </el-col>
    </el-row>
    ...
    <el-row class="module_margin_bottom tableInfo">
      ...
      <el-col :span="24" class="table_tr" v-show="isAgreement == '2'">
        <el-col :span="24" class="table_tr textarea_module" >
          ...
          <el-col :span="20" class="textareawrap"><div class="textarea"><textarea :rows="10" class="textarea_disabled" disabled v-model="reject" placeholder="请说明拒绝原因" maxlength="2000"></textarea></div></el-col>
        </el-col>
      </el-col>
      <!--<el-col :span="24" class="table_tr">
        <el-col :span="24" class="table_tr textarea_module" v-show="isAgreement == '1'">
          ...
          <el-col :span="20" class="textareawrap"><div class="textarea"><textarea :rows="10" class="textarea_disabled" disabled v-model="loanLastCheckOpinion" placeholder="请输入放款终审意见，或其他备注信息" maxlength="2000"></textarea></div></el-col>
        </el-col>
      </el-col>-->
    </el-row>
