  ...
  <div class="public">
      ...
      <el-col :span="24" class="table_tr">
        ...
        <el-col :span="9" class="table_td">
          <el-col :span="15" class="table_td">
            {{$route.query.declareTime}}
          </el-col>
        </el-col>
        <el-col :span="3" class="table_td">申报编号</el-col>
        <el-col :span="9" class="table_td">
          <el-col :span="15" class="table_td">{{$route.query.declareNo}}</el-col>
    ...
    <div class="last_btn_wrap">
      <ul class="last_btn_box">
        <li class="last_btn"><el-button  @click="$router.push('/declarelist')">返回</el-button></li>
      </ul>
    </div>
  </div>
</template>
