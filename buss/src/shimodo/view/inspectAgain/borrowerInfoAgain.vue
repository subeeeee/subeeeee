<template>
	<div class="borrowMoney">
          ...
          <el-col :span="24" class="table_tr textarea_module" >
            ...
            <el-col :span="21" class="textareawrap"><div class="textarea"><textarea disabled v-model="stateOfBusiness" :rows="3" placeholder="请输入企业经营状况" :maxlength="255"></textarea></div></el-col>
				...
				<!--<el-col :span="24" class="table_tr" v-if="this.ruleForm.businessType == '02'|| this.ruleForm.businessType == '04'">
					...
					<el-col :span="9" class="table_td">
						<el-col :span="14" :offset="1">
							<el-input disabled v-model="ruleForm.LoanBankBranch" @blur="verify(11)"  placehold="贷款银行支行" size="small"></el-input>
						</el-col>
						<el-col :span="9" class="error_title" v-if="ruleFormShow.LoanBankBranch">抵押顺位不可为空</el-col>
					</el-col>
					&lt;!&ndash;<el-col :span="3" class="table_td">银行尾款(万元)<span class="importent">*</span></el-col>
					<el-col :span="9" class="table_td">
						<el-col :span="14" :offset="1">
							<el-input disabled v-model="ruleForm.finalPayment" @blur="verify(1,2)" placehold="银行尾款" size="small"></el-input>
						</el-col>
						<el-col :span="9" class="error_title" v-if="ruleFormShow.finalPayment">金额为数字不为空</el-col>
					</el-col>&ndash;&gt;
				</el-col>-->
		...
		<picModule  :bussNo="$route.query.bussNo" dataType="1" taskType="138" :details="true"/>
      ...
      queryEnum(){
        this.$http({
          ...
          callback:res=>{
			...
			save() {
        $.post(this._path + '/dataCheck/checkLoanImage',{bussNo:this.$route.query.bussNo,isFullLoan:'1'},res=>{
          if(res.resultCode === '0000'){
            ...
            window.bus.$emit('isFullLoan',res.data.isFullLoan);
          }else{
