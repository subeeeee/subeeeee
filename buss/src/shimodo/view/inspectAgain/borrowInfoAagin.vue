    ...
    <el-row v-for="(item,index) in borrowerPersonList" v-show="activeIndex == index">
      <el-row class="tableInfo table_height">
        ...
        <el-col :span="24" class="table_tr">
          ...
          <el-col :span="21" class="table_td bmp_selectleft idcart">
            <el-col :span="19">
        ...
        <el-col :span="24" class="table_tr">
          ...
          <el-col :span="10" class="table_td">
            <el-col :span="23" disabled :offset="1" class="bmp_selectleft">
       ...
       <!-- <el-col :span="24" class="table_tr">
        ...
        <el-col :span="24" class="table_tr">
          ...
          <el-col :span="19" class="table_td">
            <el-col :span="16" offset="1"  class="bmp_selectleft">
              <el-select disabled v-model="item.properties" @change="fn" size="small" class="bmp_nature" placeholder="单位性质">
            ...
            <!--<el-col :span="8" class="error_title" v-if="borrowerBolList[index].properties"> *单位性质不可为空</el-col>-->
          </el-col>
        </el-col>
        <el-col :span="24" class="table_tr">
        ...
        <el-col :span="24" class="table_tr">
          ...
          <el-col :span="19" class="table_td">
            ...
            <!--<el-col :span="8" class="error_title" v-if="borrowerBolList[index].occupation"> *职位不可为空</el-col>-->
          </el-col>
...
-->
        ...
        <el-col :span="24" class="table_tr">
          ...
          <el-col :span="19" class="table_td bmp_selectleft idcart">
        ...
        <!--是否为黑户-->
  <!--      <el-col :span="24" class="table_tr">
          &lt;!&ndash;<el-col :span="3" class="table_td">企业经营状况</el-col>
          <el-col :span="9" class="table_td">
            <el-col :span="14" :offset="1">
       ...
       <!-- <el-col :span="24" class="table_tr">
          ...
          &lt;!&ndash;<el-col :span="3" class="table_td">负债(万元)<span class="importent">*</span></el-col>
          <el-col :span="9" class="table_td">
            <el-col :span="14" :offset="1">
      ...
      <picModule :bussNo="$route.query.bussNo" dataType="2" taskType="138" :custId="item.releId" :details="1" class="module_margin_bottom"/>
      ...
      <el-col :span="8" :offset="10" class="btn">
        ...
        <el-button @click="save(index)">保存借款人基本信息</el-button>
       </el-col>
...
<script>
  ...
  export default {
    ...
    methods: {
      save(index) {
        // checkCustImage
        $.post(this._path + '/dataCheck/checkCustImage',{bussNo:this.$route.query.bussNo,isFullCust:'1',custNo:this.borrowerPersonList[index].id},res=>{
