      ...
      <el-col :span="24" class="table_tr">
        ...
        <el-col :span="9" class="table_td">
          <el-col :span="13" :offset="1">
            <el-radio-group v-model="pawnInfo.coverfive" disabled>
        ...
        <el-col :span="6" class="table_td" style="border:none">
          <el-radio disabled v-model="pawnInfo.sole" label="1" disabled>唯一</el-radio>
          <el-radio disabled v-model="pawnInfo.sole" label="0" disabled>非唯一</el-radio>
        </el-col>
      </el-col>
      <el-col :span="24" class="table_tr">
