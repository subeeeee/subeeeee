<template>
  <div class="borrowLink">
    ...
    <picModule :bussNo="$route.query.bussNo" dataType="5" taskType="136" class="module_margin_bottom" :details="false"/>
    ...
    <picModule dataType="6" :bussNo="$route.query.bussNo" taskType='136'  :details="false"  class="module_margin_bottom addImg"/>-->
    <div class="show_list_title">
    ...
    <el-row class=" module_margin_bottom tableInfo">
      <el-col :span="24" class="table_tr">
        <el-col :span="24" class="table_tr textarea_module" >
          ...
          <el-col :span="21" class="textareawrap"><div class="textarea"><textarea :rows="4" class="textarea_disabled" disabled  v-model="remark"   maxlength="500"></textarea></div></el-col>
        </el-col>
      </el-col>
    </el-row>
    ...
    beforeCreate () {
      $.post(this._path + '/dataReturn/queryBusDataReturnByBussNo',{bussNo:this.$route.query.bussNo},res=>{
        if(res.resultCode === '0000'){
          ...
          this.remark = res.data.busDataVo.remark;
        }else{
