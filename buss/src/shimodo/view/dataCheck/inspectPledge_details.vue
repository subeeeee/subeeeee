<template>
	<div class="pledge">
      ...
      <el-col :span="24" class="table_tr">
        ...
        <el-col :span="9" class="table_td">
          <el-col :span="14" :offset="1">
            <el-input size="small" disabled :maxlength="20"  v-model="pawnInfo.formerPrice" @blur="inspectFormat('原购价')"></el-input>
          </el-col>
      ...
      </el-col><el-col :span="24" class="table_tr">
      ...
      <el-col :span="24" class="table_tr">
		...
		<picModule :bussNo="$route.query.bussNo" dataType="3" taskType="138" :details="false" class="module_margin_bottom"/>
		<!-- 抵押物勘察影像信息 -->
		<div class="show_list_title">
			<h3><img src="./../../../assets/pic.png" class="listTitleImg"><span>抵押物勘察影像信息</span></h3>
		</div>
    <picModule :bussNo="$route.query.bussNo" dataType="4" taskType="138" :details="false" class="module_margin_bottom"/>
		...
		<el-row class="module_margin_bottom tableInfo">
          ...
          <el-col :span="2">厨</el-col>
			...
			<!--<el-col :span="24" class="table_tr" v-show="roomInfo.serviceCondition == '02'">
				...
				<el-col :span="9" class="table_td">
					<el-col :span="14" :offset="1">
						<el-input disabled size="small" v-model="roomInfo.tenantName"></el-input>
					</el-col>
				...
				<el-col :span="9" class="table_td">
					<el-col :span="14" :offset="1">
						<el-input disabled size="small" v-model="roomInfo.tenantIDCard"></el-input>
					</el-col>
			...
			<el-col :span="24" class="table_tr" v-show="roomInfo.serviceCondition == '02'">
				...
				<el-col :span="9" class="table_td">
					<el-col :span="14" :offset="1">
						<el-input disabled size="small" v-model="roomInfo.monthlyPrice"></el-input>
					</el-col>
          ...
          <el-col :span="6">
			...
			<!--<el-col :span="24" class="table_tr">
				...
				<el-col :span="21" class="table_td table_tr">
					<el-col :span="2">描述</el-col>
					<el-col :span="21">
						<el-input disabled size="small" v-model="aroundGua.disfacilityDescribe"></el-input>
					</el-col>
				</el-col>
			</el-col>-->
		</el-row>
      ...
      <el-col :span="24" class="table_tr" v-for="(item,index) in guaValue.assess">
        ...
        <el-col :span="4" class="table_td">
          <el-col :span="22" :offset="1">
            <el-input disabled size="small" v-model="item.intermediary"></el-input>
          </el-col>
        </el-col>
        <el-col :span="4" class="table_td">市场价(万元)<span v-if="!index" class="importent">*</span></el-col>
        <el-col :span="4" class="table_td">
          <el-input disabled size="small" class="price" v-model="item.marketPrice"></el-input>
        </el-col>
        <el-col :span="4" class="table_td">快卖价格(万元)<span v-if="!index" class="importent">*</span></el-col>
        <el-col :span="4" class="table_td">
          <el-input disabled size="small" class="price" v-model="item.fastPrice"></el-input>
        </el-col>
      </el-col>
          ...
          <el-col :span="22" :offset="1">
            <el-input disabled size="small" v-model="item.orgName"></el-input>
				...
				<el-col :span="3" class="table_td">单价(万元)</el-col>
				<el-col :span="5" class="table_td">
          <el-col :span="22" :offset="1">
            <el-input disabled size="small" v-model="item.unitPrice"></el-input>
          </el-col>

				</el-col>
				<el-col :span="3" class="table_td">总价(万元)</el-col>
				<el-col :span="5" class="table_td">
          <el-col :span="22" :offset="1">
            <el-input disabled size="small" v-model="item.totalPrice"></el-input>
          </el-col>
		...
		<!--<el-row class=" module_margin_bottom tableInfo">
			...
			<el-col class="table_tr " :span="24" v-for="(item,index) in networkInquiry.maleBargain">
				<el-col class="table_td" :span="4">
					<el-date-picker :editable="false" disabled size="small" class="resultWidth" v-model="item.dealTime" type="date" placeholder="选择日期" :picker-options="pickerOptions0"></el-date-picker>
				</el-col>
				<el-col class="table_td" :span="4">
				...
				<el-col class="table_td" :span="4">
					<el-input disabled size="small" class="resultWidth" v-model="item.dealPrice"></el-input>
				</el-col>
				<el-col class="table_td" :span="4">
					<el-input disabled size="small" class="resultWidth" v-model="item.dealArea"></el-input>
				</el-col>
				<el-col class="table_td" :span="4">
		...
		<!-- 网询截图 -->
		<!--<picModule :bussNo="$route.query.bussNo" dataType="5" taskType="138" :details="false"/>-->
		<!-- 以下是弹框 -->
		<el-dialog title="房屋共有情况" :visible.sync="markShow.isAmendHouseOwnedInfoMark" size="tiny">
			<el-row>
				<el-col :span="24" v-for="item in pawnInfo.allot" class="mark_table_line">
					...
					<el-col :span="15">
						<el-input disabled size="small" v-model="item.scale"></el-input>
					</el-col>
				</el-col>
			</el-row>
			<span slot="footer" class="dialog-footer">
    <el-button @click="isAmendHouseOwnedInfoMark = false">取 消</el-button>
