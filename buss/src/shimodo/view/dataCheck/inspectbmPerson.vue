<template>
  <div class="borrowMoneyPerson">
    ...
    <el-row v-for="(item,index) in borrowerPersonList" v-show="activeIndex == index">
      <el-row class="tableInfo table_height">
        <el-col :span="24" class="table_tr" v-if="index">
          ...
          <el-col :span="20" :offset="1" class="table_td" style="text-align:left">
            <el-col :span="15" :offset="1">
              <el-select v-model="item.relType" size="small" class="bmp_selectWidth" placeholder="房屋所有权人">
                <el-option value="01" label="房屋所有权人" key="01"></el-option>
                <el-option value="03" label="共借人" key="03"></el-option>
              </el-select>
              与
              <el-select v-model="item.relName" size="small" placeholder="已添加借款人、房屋所有权人列表">
                <el-option v-for="data in nameTotalList" :key="data.label" :label="data.label" :value="data.label"></el-option>
              </el-select>
              关系
              <el-select v-model="item.relationship" size="small" class="bmp_selectWidth" placeholder="关系">
        ...
        <el-col :span="24" class="table_tr">
          ...
          <el-col :span="18" class="table_td bmp_selectleft idcart">
            <el-col :span="19">
              <el-select v-model="item.shen" @visible-change="(val)=>getarea(val,item.shen,index)" size="small" class="allSe" placeholder="省">
              ...
              <el-select v-model="item.shi" size="small" @visible-change="(val)=> getare(val,item.shi,index)" class="allSe" placeholder="市">
                <el-option v-for="data in cityListVoList" :value="data.cityCode" :label="data.cityName" :key="data.cityCode"></el-option>
              </el-select>
              <el-select v-model="item.famregisterCode" @change="verify(item.famregisterCode, 14, index,item.famregisterDetail)" size="small" class="allSe" placeholder="区">
                <el-option v-for="data in areaList" :value="data.areaCode" :label="data.areaName" :key="data.areaCode"></el-option>
              </el-select>
              <el-input size="small" :maxlength="50"  @blur="verify(item.famregisterCode, 14, index,item.famregisterDetail)" v-model="item.famregisterDetail" class="bmp_input" placeholder="详细地址"></el-input>
            </el-col>
        ...
        <el-col :span="24" class="table_tr">
          ...
          <el-col :span="9" class="table_td">
            <el-col :span="14" class="bmp_selectleft" :offset="1">
              <el-select v-model="item.nation" @change="verify(item.nation,16,index)" size="small" placeholder="民族">
        ...
        <el-col :span="24" class="table_tr">
          ...
          <el-col :span="21" class="table_td">
            <el-col :span="4" >
              <el-radio-group v-model="item.isLong" @change="(val)=>verify(val,'cardLine',index)">
                <el-radio label="01">长期</el-radio>
                <el-radio label="02">短期</el-radio>
              </el-radio-group>
            </el-col>
            <el-col :span="5" v-if="item.isLong === '02'">
              <el-date-picker  :editable="false" size="small" class="select_width" v-model="item.cardLine" type="date" placeholder="身份证有效期" @change="(val)=>verify(val,'cardLine',index)"></el-date-picker>
            </el-col>
        ...
        <!--  <el-col :span="24" class="table_tr">
            ...
            <el-col :span="9" class="table_td">
              <el-col :span="14" :offset="1">
                <el-input size="small" disabled  @blur="verify(item.university,17,index)" v-model="item.university" placeholder="请输入毕业院校">
                </el-input>
              </el-col>
              <el-col :span="9" class="error_title" v-if="borrowerBolList[index].university">毕业院校不可为空</el-col>
            </el-col>
            <el-col :span="3" class="table_td">最高学历</el-col>
            <el-col :span="9" class="table_td">
              <el-col :span="14" :offset="1" class="bmp_selectleft">
                <el-select v-model="item.highestEducation" disabled @change="verify(item.highestEducation,18,index)" size="small" placeholder="最高学历">
                  <el-option value="10" label="研究生" key="10"></el-option>
                  <el-option value="20" label="大学本科" key="20"></el-option>
                  <el-option value="30" label="大学专科" key="30"></el-option>
                  <el-option value="40" label="中专/中等技校" key="40"></el-option>
        ...
        <!--<el-col :span="24" class="table_tr">
          ...
          <el-col :span="9" class="table_td">
            <el-col :span="14" :offset="1">
              <el-input size="small" disabled v-model="item.workUnit" @blur="verify(item.workUnit,4,index)" placeholder="请输入工作单位">
              </el-input>
            </el-col>
        ...
        <el-col :span="24" class="table_tr">
          ...
          <el-col :span="18" class="table_td">
            <el-col :span="16" style="margin-left: 2%" class="bmp_selectleft">
              ...
              <el-select v-model="item.propertiesDetail" size="small" @change="fnValDeta(index,0)" class="bmp_nature" placeholder="单位性质">
        ...
        <el-col :span="24" class="table_tr">
          ...
          <el-col :span="9" class="table_td">
            <el-col :span="14" :offset="1">
              <el-input size="small" disabled v-model="item.custPost" @blur="verify(item.custPost,21,index)" placeholder="请输入岗位"></el-input>
            </el-col>
            <el-col :span="8" class="error_title" v-if="borrowerBolList[index].custPost">*岗位不可为空</el-col>
          </el-col>-->
        </el-col>
        ...
        <el-col :span="24" class="table_tr">
          ...
          <el-col :span="18" class="table_td">
            <el-col :span="16" style="margin-left: 2%" class="bmp_selectleft">
              <el-select v-model="item.occupation" size="small" @change="fnValoccupat(index,1)" class="bmp_nature" placeholder="职位">
                <el-option v-for="data in _utils.occupa" :value="data.code" :label="data.label" :key="data.code"></el-option>
              </el-select>
              <el-select v-model="item.occupationDetail" @change="fnValDeta(index,1)" size="small" class="bmp_nature" placeholder="职位">
        ...
        <!--<el-col :span="24" class="table_tr">
          ...
          <el-col :span="9" class="table_td">
            <el-col :span="14" :offset="1">
              <el-input size="small" disabled v-model="item.workYear" @blur="verify(item.workYear,8,index)" placeholder="请输入工作年限(年)"></el-input>
            </el-col>
          ...
          <el-col :span="9" class="table_td">
            <el-col :span="14" :offset="1">
              <el-input size="small" disabled v-model="item.income" @blur="verify(item.income,10,index)" placeholder="请输入年收入(万元)"></el-input>
            </el-col>
       ...
       <!-- <el-col :span="24" class="table_tr">
          ...
          <el-col :span="9" class="table_td">
            <el-col :span="14" class="bmp_selectleft" :offset="1">
              <el-radio v-model="item.overdueReporting" label="1">有逾期</el-radio>
              <el-radio v-model="item.overdueReporting" label="2">无逾期</el-radio>
            </el-col>
          </el-col>
        </el-col>-->
        ...
        <!--<el-col :span="24" class="table_tr">
          ...
          <el-col :span="9" class="table_td">
            <el-col :span="14" :offset="1" class="bmp_selectleft">
              连
              <el-input size="small" class="bmp_credit" :maxlength="4" @blur="verify(item.loanEven,11,index,1,item.loanTired)" v-model="item.loanEven"></el-input>
              累
              <el-input size="small" class="bmp_credit" :maxlength="4" @blur="verify(item.loanTired,11,index,0,item.loanEven)" v-model="item.loanTired"></el-input>
            </el-col>
          ...
          <el-col :span="9" class="table_td">
            <el-col :span="14" :offset="1" class="bmp_selectleft">
              连
              <el-input size="small" class="bmp_credit" :maxlength="4" @blur="verify(item.cardEven,12,index,1,item.cardTired)" v-model="item.cardEven"></el-input>
              累
              <el-input size="small" class="bmp_credit" :maxlength="4" @blur="verify(item.cardTired,12,index,0,item.cardEven)" v-model="item.cardTired"></el-input>
            </el-col>
        ...
        <el-col :span="24" class="table_tr">
          ...
          <el-col :span="18" class="table_td bmp_selectleft idcart">
            <el-col :span="19">
              ...
              <el-input size="small" :maxlength="50" @blur="verify(item.residentAddressCode, 22, index,item.residentAddressDetail)" v-model="item.residentAddressDetail" class="bmp_input" placeholder="常住地址"></el-input>
            </el-col>
      ...
      <div class="show_list_title" style="margin-top: 20px">
        <h3><img src="../../../assets/pic.png" class="listTitleImg"><span>借款人影像信息</span></h3>
      </div>
      <picModule :bussNo="$route.query.bussNo" dataType="2" taskType="138" :custId="item.releId" class="module_margin_bottom"/>
      ...
      <el-col :span="8" :offset="10" class="btn">
        <el-button @click="delBorrower(activeIndex,item)" v-if="index != '0'">删除该借款人信息</el-button>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      fnValoccupat(index,val){
        if(!this.borrowBol2){
          this.borrowBol2 = true
          return
        }
      ...
      fnValDeta(index,val){
        if(val == '0'){
          if(!this.propertiesBol){
            this.propertiesBol = true
            return
          }
          ...
          if(!this.occupationBol){
            this.occupationBol = true
            return
          }
      ...
      save(item, index) {
        ...
        for(let j = 0;j<this.borrowerBolList.length;j++){
          ...
          this.verify(this.borrowerPersonList[j].loanEven, 11, j, 1,this.borrowerPersonList[j].loanTired)
        ...
        //  this.verify(item.custPost,20,index)
        ...
        for (let i = 0; i < this.borrowerPersonList.length; i++) {
          ...
          //  联系电话
          // && !this.borrowerBolList[i].university  毕业院校
          // && !this.borrowerBolList[i].highestEducation 最高学历
          // && !this.borrowerBolList[i].workUnit 工作单位
          // && !this.borrowerBolList[i].highestDegree 最高学位
          // && !this.borrowerBolList[i].custPost 岗位
          // && !this.borrowerBolList[i].nation   民族
...
console.log(this.borrowerBolList[index].highestDegree,this.borrowerBolList[index].workUnit,this.borrowerBolList[index].cardLine)
        ...
        if(this.allIsbol){
          window.bus.$emit('isFullCustShowR', 1)
        }else{
          window.bus.$emit('isFullCustShowR', 0)
        }
        ...
        $.post(this._path + '/dataCheck/insertCustLogSave', this.addObj, (res) => {
          if (res.resultCode == '0000') {
            ...
            this.$set(this.borrowerBolList[index],'isfullCust',res.data.isFullCust);
            let bol = false
      ...
      verifyPerson(data, inde, index, content,data2) {
        switch (data) {
          ...
          /* case "身份证号":
             let i = index
                 if (18 == content.length||15 == data.length) {
    ...
    beforeCreate() {
      ...
      $.post(this._path + "/dataCheck/selectBusCustLogListBybussNo", params, (res) => {
        ...
        for (let i = 0; i < data.length; i++) {
          ...
          !data[i].famregisterCode?data[i].famregisterCode = '':data[i].famregisterCode
          !data[i].famregisterDetail?data[i].famregisterDetail='':data[i].famregisterDetail
          !data[i].nation?data[i].nation='':data[i].nation
          !data[i].highestEducation?data[i].highestEducation='':data[i].highestEducation
          !data[i].highestDegree?data[i].highestDegree='':data[i].highestDegree
          bbList[i] = {
            isErrorBrower: false,
            certNo: false,
            certName: false,
          ...
          $.post(this._path + "/dataCheck/selectBusFamilyInfoLogBycustNo", params, (res) => {
            ...
            /*if(!this.borrowerPersonList[i].overdueReporting){
              this.borrowerPersonList[i].overdueReporting = '2'
            }*/
