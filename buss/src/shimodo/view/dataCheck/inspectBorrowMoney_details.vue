	...
	<div class="borrowMoney">
				...
				<el-col :span="24" class="table_tr">
					...
					<el-col :span="9" class="table_td">
						<el-col :span="14" class="bmp_selectleft" :offset="1">
							<el-select disabled v-model="ruleForm.month" @change="verify(7)" size="small" placeholder="申请期限">
        ...
        <el-col :span="24" class="table_tr">
          ...
          <el-col :span="21" class="table_td">
            ...
            <el-col :span="9" class="error_title" v-if="ruleFormShow.moneyUse">不为特殊字符或为空</el-col>
          </el-col>
        </el-col>
				<el-col :span="24" class="table_tr">
              ...
              <el-select disabled v-model="ruleForm.payment" @visible-change="(val)=>verify(3,val)" class="select_width" size="small" placeholder="请选择还款来源">
                <el-option v-for="item in paymentList" :value="item.key" :label="item.value" :key="item.key"></el-option>
						...
						<el-col :span="9" class="error_title" v-if="ruleFormShow.payment">不为特殊字符或为空</el-col>
					</el-col>
				</el-col>
            ...
            <el-col :span="21" class="textareawrap"><div class="textarea"><textarea disabled v-model="stateOfBusiness" :rows="3" placeholder="请输入企业经营状况" :maxlength="255"></textarea></div></el-col>
				...
				<el-col :span="24" class="table_tr">
					...
					<el-col :span="7" class="table_td">
						<el-col :span="14" class="bmp_selectleft" :offset="1">
							<el-date-picker disabled v-model="ruleForm.valueDate" @change="verify(8)" size="small" type="date" placeholder="选择日期">
							</el-date-picker>
						</el-col>
					...
					<el-col :span="9" class="table_td">
						<el-col :span="14" class="bmp_selectleft" :offset="1">
							<el-select disabled v-model="ruleForm.relation" size="small" @change="verify(9)" placeholder="实际用款人与借款人关系">
				...
				<el-col :span="24" class="table_tr" v-if="!(this.ruleForm.relation == '1' || this.ruleForm.relation == '2')">
					...
					<el-col :span="9" class="table_td">
						<el-col :span="14" :offset="1">
							<el-input disabled v-model="ruleForm.practical" @blur="verify(5)" :maxlength="32" size="small"></el-input>
						</el-col>
				...
				<el-col :span="24" class="table_tr" v-if="!(this.ruleForm.relation == '1' || this.ruleForm.relation == '2')">
					...
					<el-col :span="16" class="table_td">
						<el-col :span="14" class="bmp_selectleft idcart">
							<el-input disabled v-model="ruleForm.identityCard" size="small" @blur="verify(6)" :maxlength="32" placehold="请输入身份证号"></el-input>
						</el-col>
				...
				<el-col :span="24" class="table_tr">
					...
					<el-col :span="9" class="table_td">
						<el-col :span="14" :offset="1" class="bmp_selectleft">
							<el-select disabled v-model="ruleForm.businessType" @change="verify(10)" size="small" placeholder="抵押顺位">
          ...
          <el-col :span="9" class="table_td">
            ...
            <el-col :span="9" class="error_title" v-if="ruleFormShow.loanType">请选择贷款类型</el-col>
				...
				<el-col :span="24" class="table_tr " v-if="this.ruleForm.isAdvance == 0">
					...
					<el-col :span="9" class="table_td">
						<el-col :span="15">
							<el-select disabled v-model="ruleForm.advanceTerm" @change="verify(12)" size="small" placeholder="垫资期限">
		...
		<picModule  :bussNo="$route.query.bussNo" dataType="1" taskType="138" :details="false"/>


		<el-row class="btn">
			<!--<el-col :span="2" :offset="11"><el-button @click="save">保存借款信息</el-button></el-col>-->
		</el-row>
	...
	export default {
		...
		methods: {
			save() {
				...
				this.verify(1, 2)
				//必填项  ！！验证
				if (!this.ruleFormShow.money && !this.ruleFormShow.finalPayment && !this.ruleFormShow.moneyUse && !this.ruleFormShow.payment && !this.ruleFormShow.businessType && !this.ruleFormShow.month && !this.ruleFormShow.valueDate && !this.ruleFormShow.relation && !this.ruleFormShow.LoanBankBranch && !this.ruleFormShow.advanceTerm) {
				} else {
				}
				//保存
