  ...
  <div class="pledge">
    ...
    <el-row class="module_margin_bottom tableInfo table_height">
      <el-col :span="24" class="table_tr">
        <el-col :span="3" class="table_td">房产证号
      ...
      <mutual-cert ref="mutualCert" @finish="finish"  v-if="!ownerBol" task-name="dataReturn"></mutual-cert>
      ...
      <el-col class="table_tr" :span="24">
        <el-col class="table_td" :span="3">抵押物坐落
          <span class="importent">*</span>
        </el-col>
        <el-col class="table_td" :span="21">
          <el-col :span="3" :class="errorShow.address" >地址</el-col>
          <el-col :span="8"><el-input size="small" :maxlength="200" v-model="pawnInfo.address" @change="changeColor('address')"></el-input></el-col>
          <el-col :span="3" :class="errorShow.build">楼栋</el-col>
          <el-col :span="3"><el-input size="small" :maxlength="50" v-model="pawnInfo.build"  @change="changeColor('build')"></el-input></el-col>
          <el-col :span="3" :class="errorShow.houseNum">门牌号</el-col>
          <el-col :span="3"><el-input size="small" :maxlength="50" v-model="pawnInfo.houseNum"  @change="changeColor('houseNum')"></el-input></el-col>
        </el-col>
      </el-col>
      <el-col :span="24" class="table_tr">
        <el-col :span="3" class="table_td">社区名称
          <span class="importent">*</span>
        </el-col>
        <el-col :span="9" class="table_td">
          <el-col :span="14" :offset="1">
        ...
        <el-col :span="3" class="table_td">所在楼层/总层数
          <span class="importent">*</span>
        </el-col>
        <el-col :span="9" class="table_td">
      ...
      <el-col :span="24" class="table_tr">
        <el-col :span="3" class="table_td">建成年代 <i class="importent">*</i></el-col>
        <el-col :span="9" class="table_td">
          <el-col :span="14" :offset="1">
            <el-select class="select_width" v-model="pawnInfo.year" @change="inspectFormat('建成年代')" placeholder="请选择"  size='small'>
              <el-option v-for="item in years" :key="item" :label="item" :value="item"></el-option>
            </el-select>
          </el-col>
          <el-col :span="9" class="error_title" v-show="errorShow.isYear"> *请填写建成年代</el-col>
        </el-col>
        <el-col :span="3" class="table_td">房龄(年) <i class="importent">*</i></el-col>
        <el-col :span="9" class="table_td">
          <el-col :span="14" :offset="1">
            <span>{{houseAge}}</span>
      ...
      <el-col :span="24" class="table_tr">
        <el-col :span="3" class="table_td">房产证取得时间<i class="importent">*</i></el-col>
        <el-col :span="9" class="table_td">
          <el-col :span="14" :offset="1"><el-date-picker :editable="false" v-model="pawnInfo.getHouseCardTime" :picker-options="pickerOptions0"  size="small" class="date_width" type="date" placeholder="选择日期时间" @change="inspectFormat('房产证取得时间')"></el-date-picker></el-col>
          <el-col :span="9" class="error_title" v-show="errorShow.getHouseCardTime">请选择</el-col>
        </el-col>
      ...
      <el-col :span="24" class="table_tr">
        ...
        <el-col :span="9" class="table_td">
          <el-col :span="14" :offset="1">
            <el-select class="select_width" @change="val=>{inspectFormat('所在区域',val)}" v-model="area" placeholder="请选择" size="small">
              <el-option v-for="area in areas" :key="area.areaCode" :label="area.areaName" :value="area.areaCode"> </el-option>
            </el-select>
          </el-col>
          <!--<el-col :span="9" class="error_title" v-show="errorShow.area">*请选择所在区域</el-col>-->
        </el-col>
      </el-col>
      <el-col class="table_tr" :span="24">
        <el-col class="table_td" :span="3">规划用途
          <span class="importent">*</span>
        </el-col>
        ...
        <el-col class="table_td" :span="9">
          <el-col :span="14" :offset="1">
            <el-select v-model="pawnInfo.houseNature" placeholder="请选择" class="select_width"  size='small' @change="val=>{inspectFormat('房屋性质',val)}">
      ...
      <el-col class="table_tr" :span="24">
        ...
        <el-col class="table_td" :span="9">
          <el-col :span="14" :offset="1">
            <el-select v-model="pawnInfo.propertyRight" placeholder="请选择" class="select_width" size='small' @change="val=>{inspectFormat('产权性质',val)}">
              <el-option v-for="item in _utils.propertyRightList" :label="item.typeName" :value="item.typeCode"></el-option>
            </el-select>

          </el-col>
          <el-col :span="9" class="error_title" v-show="errorShow.propertyRight"> *请选择产权性质</el-col>
        </el-col>
        <el-col class="table_td" :span="3">土地来源<span class="importent">*</span></el-col>
        <el-col class="table_td" :span="9">
          <el-col :span="14" :offset="1">
            <el-select v-model="pawnInfo.landSource" placeholder="请选择" class="select_width" size='small' @change="val=>{inspectFormat('土地来源',val)}">
              <el-option v-for="item in _utils.landSourceList" :label="item.name" :value="item.code"></el-option>
            </el-select>

          </el-col>
          <el-col :span="9" class="error_title" v-show="errorShow.landSource"> *请选择土地来源</el-col>
        </el-col>
      </el-col>
      <el-col :span="24" class="table_tr">
        ...
        <el-col :span="9" class="table_td">
          <el-col :span="13" :offset="1">
            <el-radio-group v-model="pawnInfo.coverfive" @change="errorShow.coverfive = false">
      ...
      <el-col :span="24" class="table_tr">
        ...
        <el-col :span="9" class=" table_td error_title" v-show="errorShow.isFormerPrice">*原购价为正数 </el-col>
      </el-col>
      <el-col :span="24" class="table_tr">
      ...
      <el-col :span="24" class="table_tr">
        <el-col :span="6" class="table_td">当前是否在押 <i class="importent">*</i></el-col>
      ...
      <el-col :span="24" class="table_tr textarea_module">
        ...
        <el-col :span="21" class="textareawrap" v-show="pawnInfo.isPledged == '1'">
          <el-col :span="19" :offset="1">
            ...
            <!--<el-input size="small" maxlength="100" v-model="pawnInfo.pledgeState" ></el-input>-->
          </el-col>
      ...
      <el-col :span="24" class="table_tr">
        ...
        <el-col :span="14" class="table_td">
          <el-radio-group v-model="pawnInfo.mortStatus" @change="val=>{inspectFormat('抵押状态',val)}">
      ...
      <el-col :span="24" class="table_tr">
        ...
        <el-col :span="14" class="table_td">
          <el-radio-group v-model="pawnInfo.isDispute" @change="errorShow.isDispute = false">
      ...
      <el-col :span="24" class="table_tr">
        ...
        <el-col :span="10" class="table_td">
          <el-radio-group v-model="pawnInfo.isOneRent"  @change="errorShow.isOneRent = false">
    ...
    <!--<el-row class="module_margin_bottom tableInfo" v-if="businessType == '02'||businessType=='04'">
      ...
      <el-col :span="24" class="table_tr" >
        ...
        <el-col :span="3" class="table_td">
          <el-radio  v-model="valueLogVos[0].isMaxAmount" label="1">是</el-radio><el-radio  v-model="valueLogVos[0].isMaxAmount" label="0">否</el-radio>
        </el-col>
      </el-col>
    </el-row>-->
    <!-- 抵押物基本影像信息 -->
    ...
    <el-col :span="3" class="table_td"></el-col>
    <picModule :bussNo="$route.query.bussNo" dataType="3" taskType="136" class="module_margin_bottom"/>
    <!-- 抵押物勘察影像信息 -->
    <div class="show_list_title">
    ...
    <picModule :bussNo="$route.query.bussNo" dataType="4" taskType="136" class="module_margin_bottom"/>
    <!-- 抵押物状态及室内信息 -->
    <div class="show_list_title">
    ...
    <el-row class="module_margin_bottom tableInfo">
      <el-col :span="24" class="table_tr">
        ...
        <el-col :span="12" class="table_td" style="border: none">
          <el-col :span="24">
        ...
        <el-col :span="9" class=" table_td error_title" style="border: none" v-show="errorShow.roomStructure && !roomInfo.roomStructure">*请选择内部结构</el-col>
      </el-col>
      <el-col :span="24" class="table_tr">
        <el-col :span="3" class="table_td">户型情况<span class="importent">*</span></el-col>
        <el-col :span="15" class="table_td" style="border: none">
          <el-col :span="2" :offset="1"><el-input  :maxlength="2" size="small" @blur="inspectFormat('户型情况')" @keyup.native="houseTypeNum(roomInfo.houseType.bedroom,'1')" v-model="roomInfo.houseType.bedroom"></el-input></el-col>
          <el-col :span="2">室</el-col>
          <el-col :span="2"><el-input :maxlength="2" size="small"  @blur="inspectFormat('户型情况')" @keyup.native="houseTypeNum(roomInfo.houseType.livingRoom,'2')" v-model="roomInfo.houseType.livingRoom"></el-input></el-col>
          <el-col :span="2">厅</el-col>
          <el-col :span="2"><el-input :maxlength="2" size="small"  @blur="inspectFormat('户型情况')" @keyup.native="houseTypeNum(roomInfo.houseType.kitchen,'3')" v-model="roomInfo.houseType.kitchen"></el-input></el-col>
          <el-col :span="2">厨</el-col>
          <el-col :span="2"><el-input :maxlength="2" size="small"  @blur="inspectFormat('户型情况')" @keyup.native="houseTypeNum(roomInfo.houseType.toilet,'4')" v-model="roomInfo.houseType.toilet"></el-input></el-col>
          <el-col :span="2">卫</el-col>
          <el-col :span="2"><el-input :maxlength="2" size="small"  @blur="inspectFormat('户型情况')" @keyup.native="houseTypeNum(roomInfo.houseType.balcony,'5')" v-model="roomInfo.houseType.balcony"></el-input></el-col>
      ...
      <el-col :span="24" class="table_tr">
        ...
        <el-col :span="5" class=" table_td error_title" style="border: none" v-show="errorShow.orientation && !roomInfo.orientation.choose">*请选择朝向情况</el-col>
      </el-col>
      <el-col :span="24" class="table_tr" >
        <el-col :span="3" class="table_td">是否有电梯<span class="importent">*</span></el-col>
        <el-col :span="5" class="table_td"  style="border: none">
        ...
        <el-col :span="4" class=" table_td error_title" > <span v-show="errorShow.hasElevator && !roomInfo.hasElevator">*请选择是否有电梯</span> &emsp;</el-col>
        <el-col :span="3" class="table_td">家装情况<span class="importent">*</span></el-col>
        <el-col :span="7" class="table_td" style="border: none">
        ...
        <el-col :span="2" class=" table_td error_title" > <span v-show="errorShow.decoration && !roomInfo.decoration">*请选择</span> &emsp;</el-col>
      </el-col>
      <el-col :span="24" class="table_tr">
        <el-col :span="3" class="table_td">使用情况<span class="importent">*</span></el-col>
        <el-col :span="6" class="table_td">
          <el-radio-group v-model="roomInfo.serviceCondition" @change="(!roomInfo.serviceCondition&&roomInfo.serviceCondition!=null)?errorShow.isServiceCondition = true:errorShow.isServiceCondition=false">
            <el-radio :label="'01'">自住</el-radio>
            <el-radio :label="'02'">出租</el-radio>
            <el-radio :label="'03'">空置</el-radio>
          </el-radio-group>
        </el-col>
        <el-col :span="5" class=" table_td error_title" > <span v-show="errorShow.serviceCondition && !roomInfo.serviceCondition">*请选择使用情况</span> &emsp;</el-col>
      </el-col>
      <el-col :span="24" class="table_tr">
        ...
        <el-col :span="21" class="table_td table_tr">
          ...
          <el-col :span="13" v-show="roomInfo.dwell == '1'">
            <el-input size="small" v-model="roomInfo.dwellDetall"  @blur="dwellDetallFn" :maxlength="200"></el-input>
          </el-col>
          <el-col :span="2">
      ...
      <el-col :span="24" class="table_tr">
        ...
        <el-col :span="4" class="table_td" style="border: none">
          <el-col :span="24">
            <el-radio v-model="roomInfo.isGardenGiven" label="1">是</el-radio>
            <el-radio v-model="roomInfo.isGardenGiven" label="0">否</el-radio>
          </el-col>
        </el-col>
        <el-col :span="3" class="table_td error_title" ><span v-show="errorShow.isGardenGiven && !roomInfo.isGardenGiven">请选择</span>&emsp;</el-col>
        <el-col :span="3" class="table_td">层高(米)</el-col>
        <el-col :span="9" class="table_td">
          <el-col :span="14" :offset="1">
            <el-input :maxlength="2" size="small" v-model="roomInfo.floorHeight" @blur="inspectFormat('层高')"></el-input>
          </el-col>
        </el-col>
      </el-col>
      <el-col class="table_tr" :span="24">
        ...
        <el-col :span="3" class="table_td error_title"><span v-show="errorShow.isOriginalPattern && !roomInfo.isOriginalPattern">请选择</span> &emsp; </el-col>
      </el-col>
    </el-row>
    <!-- 抵押物社区及周边信息 -->
    <div class="show_list_title">
      ...
      <el-col :span="24" class="table_tr">
        ...
        <el-col :span="21" class="table_td">
          ...
          <el-col :span="17" v-show="aroundGua.traffic == '1'">
            ...
            <el-col :span="4"><el-input :maxlength="32"  size="small" v-model="aroundGua.line"></el-input></el-col>
            <el-col :span="2">号线</el-col>
            <el-col :span="4"><el-input :maxlength="20" size="small" v-model="aroundGua.subway"></el-input></el-col>
            <el-col :span="4">站，步行距离</el-col>
            <el-col :span="5"><el-input :maxlength="20" size="small" v-model="aroundGua.distance"></el-input></el-col>
      ...
      <el-col :span="24" class="table_tr" v-for="(item,index) in guaValue.assess">
        ...
        <el-col :span="4" class="table_td">
          <el-col :span="22" :offset="1">
            <el-input :maxlength="32" @keyup.native="clearSpeaceAssess(item.intermediary,index,'intermediary')" size="small" v-model="item.intermediary"></el-input>
          </el-col>
        </el-col>
        <el-col :span="4" class="table_td">市场价(万元)<span v-if="!index" class="importent">*</span></el-col>
        <el-col :span="4" class="table_td">
          <el-input :maxlength="20" @keyup.native="clearNumAssess(item.marketPrice,index,'marketPrice')" size="small" class="price" v-model="item.marketPrice"></el-input>
        </el-col>
        <el-col :span="4" class="table_td">快卖价格(万元)<span v-if="!index" class="importent">*</span></el-col>
        <el-col :span="4" class="table_td">
          <el-input :maxlength="20" @keyup.native="clearNumAssess(item.fastPrice,index,'fastPrice')" size="small" class="price" v-model="item.fastPrice"></el-input>
        </el-col>
    ...
    <el-col :span="2" :offset="11"><el-button @click="saveAll">保存抵押物信息</el-button></el-col>
  ...
  export default {
    ...
    methods: {
      ...
      mustWrite () {
        ...
        /* //所在区域
         if(!this.pawnInfo.area){
           this.errorShow.area = true;
           this.isSuccess = false
         }else{
           this.errorShow.area = false;
         }*/
        //规划用途
        ...
        if(this.pawnInfo.isPledged == '1' &&  !this.pawnInfo.pledgeState){
        ...
        //内部结构
        if(!this.roomInfo.roomStructure){
        ...
        //实际用房
        // if(!this.roomInfo.practicalApplication){
        //   this.errorShow.practicalApplication = true;
        //   this.isSuccess = false
        // }else{
        //   this.errorShow.practicalApplication = false
        // }
        /* //中介机构
         ...
         //快卖价格
         if(!this.guaValue.immediateSelaPrice){
      ...
      structureSpeace(str){
        this.roomInfo.remould = this._utils.clearSpeace(str)
      },
      //户型情况
      ...
      dwellDetallFn(){
        if(/\s+/g.test(this.roomInfo.dwellDetall)){
          this.$message({
            message: "输入信息中不可包含空格！"
          });
        }
        if(this.roomInfo.dwellDetall){
          this.errorShow.dwellDetall = ''
        }
      },
      amendHouseOwnedInfo() {
      ...
      inspectFormat(type,val) {
        switch (type) {
          ...
          case "房龄":
            /*if(!this.pawnInfo.houseAge){
              this.errorShow.isHouseAge = false;
            } else if ( this.pawnInfo.houseAge * 1 < 50 && this.pawnInfo.houseAge * 1 >= 1 ) {
              this.errorShow.isHouseAge = false;
            } else {
              this.errorShow.isHouseAge = true;
            }*/
          ...
          case "规划用途":
            ...
            break;
          case "原购价":
            if(!this.pawnInfo.formerPrice){
              this.errorShow.isFormerPrice = false;
            }else if (this.pawnInfo.formerPrice * 1 >= 1) {
              this.errorShow.isFormerPrice = false;
            } else {
      ...
      saveAll(fn,str) {
        ...
        aversionRemark = `${aversionRemark},备注,${this.aroundGua
          .disfacilityDescribe}`;
        ...
        let params = {
          ...
          // guaInternetConsuleLogVos:JSON.stringify(guaInternetConsuleLogVos),
        ...
        if (this.isSuccess) {
          window.bus.$emit("isFullGuaShow", '11');
          params.isFullGua = '11'
        } else {
          window.bus.$emit("isFullGuaShow", '00');
          params.isFullGua = '00'
        ...
        $.post(this._path + "/dataReturn/insertGuaLogSave", params, res => {
          if (res.resultCode == "0000") {
            ...
            window.bus.$emit('isFullGuaShow',res.data.isFullGua);
          } else {
            this.$message({
              type: "error",
              message: "保存失败",
    ...
    created () {
      ...
      window.bus.$on('/infoPassHaul/pledge',(fn,str) => {
        this.saveAll(fn,str);
      });
      $.post(
      ...
      $.post(
        ...
        res => {
          ...
          this.pawnInfo.isPledged =  data.isPledged?data.isPledged:'0';
          ...
          this.pawnInfo.sole = data.isOnly?data.isOnly:'0';
      ...
      $.post(
        ...
        res => {
          ...
          if(res.data.voList.length==0){
            this.guaValue.assess =  [{ intermediary: "", marketPrice: "", fastPrice: "" }]
          }else{
            this.guaValue.assess = res.data.voList;
          }
          if(this.guaValue.assess.length == 1){
    ...
    beforeDestroy () {
      window.bus.$off('/infoPassHaul/pledge');
    }
  };
</script>
