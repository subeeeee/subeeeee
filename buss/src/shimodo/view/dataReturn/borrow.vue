<template>
  <div class="borrowMoney">
    ...
    <div class="show_list_title">
      <h3><img src="../../../assets/message.png" class="listTitleImg"><span>借款信息</span></h3>
				...
				<el-col :span="24" class="table_tr">
					...
					<el-col :span="9" class="table_td">
						<el-col :span="14" :offset="1">
							<el-input v-model.number="ruleForm.money" :maxlength="20" size="small" @blur="verify(1,1)"></el-input>
						</el-col>
					...
					<el-col :span="9" class="table_td">
						<el-col :span="14" class="bmp_selectleft" :offset="1">
							<el-select v-model="ruleForm.month" class="select_width" @visible-change="(val)=>verify(7,val)"  size="small" placeholder="请选择申请期限">
        ...
        <el-col :span="24" class="table_tr">
          ...
          <el-col :span="9" class="table_td text ">
            <el-col :span="14" :offset="1">
              ...
              <!--<el-input v-model="ruleForm.moneyUse" @blur="verify(2)" :maxlength="200" size="small"></el-input>-->
            </el-col>
        ...
        <!--<el-col :span="24" class="table_tr">
                    ...
                    <el-col :span="21" class="table_td">
                        <el-col :span="14" :offset="1">
                            <el-input v-model="ruleForm.payment" @blur="verify(3)" :maxlength="200" size="small"></el-input>
                        </el-col>
        ...
        <el-col :span="24" class="table_tr">
          ...
          <el-col :span="7" class="table_td">
            <el-col :span="14" class="bmp_selectleft" :offset="1">
              <el-date-picker  :editable="false" v-model="ruleForm.valueDate" size="small" type="date" placeholder="选择日期" :picker-options="pickerOptions0">
              </el-date-picker>
            </el-col>
          </el-col>
          ...
          <el-col :span="9" class="table_td">
            <el-col :span="14" class="bmp_selectleft" :offset="1">
              <el-select v-model="ruleForm.relation"  @visible-change="(val)=>verify(9,val)" size="small" placeholder="请选择关系">
                <el-option v-for="item in relationList" :value="item.code" :label="item.relation" :key="item.code"></el-option>
              </el-select>
            </el-col>
            <el-col :span="8" class="error_title" v-if="ruleFormShow.relation">关系不可为空</el-col>
          </el-col>
        </el-col>
        ...
        <el-col :span="24" class="table_tr" v-if="!(this.ruleForm.relation == '1' || this.ruleForm.relation == '2'|| !this.ruleForm.relation)">
          ...
          <el-col :span="9" class="table_td">
            <el-col :span="14" :offset="1">
              <el-input v-model="ruleForm.practical" :maxlength="32" @blur="verify(5)" size="small"></el-input>
            </el-col>
        ...
        <el-col :span="24" class="table_tr">
          ...
          <el-col :span="9" class="table_td">
            <el-col :span="14" :offset="1" class="bmp_selectleft">
              <el-select v-model="ruleForm.businessType" size="small" placeholder="抵押顺位">
        ...
        <el-col :span="24" class="table_tr" v-if="ruleForm.businessType == '02'|| ruleForm.businessType == '04'">
          ...
          <el-col :span="9" class="table_td">
            <el-col :span="14" :offset="1">
              <el-input v-model="ruleForm.LoanBankBranch" @blur="verify(11)" :maxlength="32" placehold="抵押机构名称" size="small"></el-input>
            </el-col>
        ...
        <el-col :span="24" class="table_tr" v-if="ruleForm.businessType == '02'|| ruleForm.businessType == '04'">
          ...
          <el-col :span="9" class="table_td">
            <el-col :span="14" :offset="1">
              <el-input v-model="ruleForm.actualMorted" @blur="verify('actualMorted','actualMorted')" @keyup.native="keyup('actualMorted','money')" :maxlength="20" placehold="实际已抵押金额" size="small"></el-input>
            </el-col>
          ...
          <el-col :span="9" class="table_td">
            <el-col :span="14" :offset="1">
              <el-input v-model="ruleForm.loanedAmount" :maxlength="20" size="small" @keyup.native="keyup('loanedAmount','money')" @blur="verify('money','loanedAmount')"></el-input>
            </el-col>
        ...
        <el-col :span="24" class="table_tr" v-if="ruleForm.businessType == '02'|| ruleForm.businessType == '04'">
          ...
          <el-col :span="9" class="table_td">
            <el-col :span="14" :offset="1">
              <el-input v-model="ruleForm.loanedTerm" @blur="verify('term','loanedTerm')" @keyup.native="keyup('loanedTerm','number')" :maxlength="2" placehold="请输入贷款期限" size="small"></el-input>
            </el-col>
        ...
        <el-col :span="24" class="table_tr " v-if="this.ruleForm.isAdvance == 0">
          ...
          <el-col :span="9" class="table_td">
            <el-col :span="14">
              <el-select v-model="ruleForm.advanceTerm"  @visible-change="(val)=>verify(12,val)" size="small" placeholder="垫资期限">
                <el-option v-for="item in month" :value="item.code"></el-option>
              </el-select>
            </el-col>
            <el-col :span="8" class="error_title" v-if="ruleFormShow.advanceTerm">垫资期限不可为空</el-col>
          </el-col>
        </el-col>
    ...
    <picModule  :bussNo="$route.query.bussNo" dataType="1" :details="true" taskType="136" />
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      save(fn,str) {
        ...
        if (!this.ruleFormShow.loanType && !this.ruleFormShow.actualMorted && !this.ruleFormShow.loanedAmount &&  !this.ruleFormShow.loanedTerm && !this.ruleFormShow.enterpriseName && !this.ruleFormShow.money  && !this.ruleFormShow.moneyUse && !this.ruleFormShow.payment && !this.ruleFormShow.businessType && !this.ruleFormShow.month  && !this.ruleFormShow.relation && !this.ruleFormShow.LoanBankBranch && !this.ruleFormShow.advanceTerm) {
          window.bus.$emit('isFullLoanShow', 1);
          params.isFullLoan = '1'
        } else {
          window.bus.$emit('isFullLoanShow', 0);
          params.isFullLoan = '0'
        }

        $.post(this._path + "/dataReturn/insertLoanLogSave", params, (res) => {
          if (res.resultCode == '0000') {
            window.bus.$emit("isFullLoanShow", res.data.isFullLoan);
        ...
        switch (type) {
          case 'loanType':
            if (this.ruleForm[type]) {
              ...
              this.ruleFormShow.loanType = true
            }
            break;
          case 'term':
          ...
          case 6:
            if(!(this.ruleForm.relation == '1' || this.ruleForm.relation == '2')){
              if(this.ruleForm.identityCard){
                if (18 == this.ruleForm.identityCard.length||15 == this.ruleForm.identityCard.length) {
    ...
    created() {
      this.queryEnum();
      window.bus.$on('/infoPassHaul/borrowMoney',(fn,str) => {
        this.save(fn,str);
      });
      let params = {
        bussNo: this.$route.query.bussNo
      ...
      $.post(this._path + '/dataReturn/queryBusLoanByBussNoAndtaskTypeReturn', params, (res) => {
        if(res.resultCode == '0000'){
          ...
          this.ruleForm.textarea = data.advanceRemark?data.advanceRemark:'';
    ...
    beforeDestroy () {
      window.bus.$off('/infoPassHaul/borrowMoney');
    }
  }
