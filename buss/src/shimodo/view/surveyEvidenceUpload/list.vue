<template>
  <div class="survey public">
      ...
      <el-col class="condition_space_between">
        ...
        <el-col :span="6">
          <el-select v-model="condition.taskStatus" placeholder="请选择" class="select_width"  size='small'>
            ...
            <el-option :label="'费用确认中'" :value="'60'"> </el-option>
    ...
    <el-table :data="tableData" border class="table">
      ...
      <el-table-column header-align="center" align="center" prop="cityName" label="城市" min-width="120"></el-table-column>
      <el-table-column header-align="center" align="center" prop="orgName" label="渠道简称" min-width="120"></el-table-column>
      ...
      <el-table-column header-align="center" align="center" prop="taskPreName" label="任务员姓名" min-width="200"></el-table-column>
      <el-table-column header-align="center" align="center" fixed="right" label="操作" min-width="200">
        <template scope="scope">
          <el-button type="text" size="small" @click="affirm(scope.row)" v-if="currentUserPermissions.indexOf('business:survey:returncost:handle') != -1" v-show="scope.row.taskStatus === '待处理'">处理</el-button>
          <el-button type="text" size="small" @click="info(scope.row)" v-if="currentUserPermissions.indexOf('business:survey:returncost:query') != -1">详情</el-button>
        </template>
      </el-table-column>
    </el-table>
    <!-- 分页按钮 -->
...
<script>
  export default {
    ...
    methods : {
      affirm(row){
        this.$http({
          url:'/busReCostInfo/toReturnCost',
          data:{bussNo:row.bussNo},
          callback:res=>{
            this.$router.push({
              path:'/surveyEvidenceUpload',
      ...
      request () {
        ...
        this.$http({
          url:'/busReCostInfo/busReturnCostPageList',
          data,
          callback:res=>{
            this.tableData = res.data.busReturnCostInfoVOList;
