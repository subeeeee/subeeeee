<template>
  <div class="borrowMoneyPerson">
    ...
    <el-row class="sadfasdf" v-for="(item,index) in borrowerPersonList" v-show="activeIndex == index">
      <el-row class="tableInfo table_height">
        ...
        <el-col :span="24" class="table_tr">
          ...
          <el-col :span="9" class="table_td">
            <el-col :span="14" :offset="1">
              <el-input disabled size="small" v-model="item.mobile" placeholder="联系电话"></el-input>
            </el-col>
            <!--<el-col :span="9" class="error_title" v-if="borrowerBolList[index].isErrormobile"> *请输入11位手机号</el-col>-->
          </el-col>
        </el-col>
        <el-col :span="24" class="table_tr">
          <el-col :span="3" class="table_td">户籍<span class="importent">*</span></el-col>
          <el-col :span="18" class="table_td bmp_selectleft idcart">
            <el-select disabled v-model="item.shen" @change="getarea" size="small" class="allSe" placeholder="省">
            ...
            <el-select disabled v-model="item.shi" size="small" @change="getare" class="allSe" placeholder="市">
              <el-option v-for="data in cityListVoList" :value="data.cityCode" :label="data.cityName" :key="data.cityCode"></el-option>
            </el-select>
            <el-select disabled v-model="item.famregisterCode" size="small" class="allSe" placeholder="区">
        ...
        <el-col :span="24" class="table_tr">
          ...
          <el-col :span="9" class="table_td">
            <el-col :span="14" class="bmp_selectleft" :offset="1">
              <el-select disabled v-model="item.nation" size="small" placeholder="民族">
        ...
        <!-- <el-col :span="24" class="table_tr">
           ...
           <el-col :span="9" class="table_td">
             <el-col :span="14" :offset="1" class="bmp_selectleft">
               <el-select disabled v-model="item.highestEducation" size="small" placeholder="最高学历">
                 <el-option value="10" label="研究生" key="10"></el-option>
                 <el-option value="20" label="大学本科" key="20"></el-option>
                 <el-option value="30" label="大学专科" key="30"></el-option>
                 <el-option value="40" label="中专/中等技校" key="40"></el-option>
        ...
        <!--<el-col :span="24" class="table_tr">
          ...
          <el-col :span="9" class="table_td">
            <el-col :span="14" :offset="1" class="bmp_selectleft">
              <el-select disabled v-model="item.highestDegree" size="small" placeholder="最高学位">
        ...
        <el-col :span="24" class="table_tr">
          ...
          <el-col :span="9" class="table_td">
            <el-col :span="14" :offset="1">
              <el-input disabled size="small" v-model="item.custPost" placeholder="请输入岗位"></el-input>
            </el-col>
          </el-col>-->
        </el-col>
        ...
        <!--<el-col :span="24" class="table_tr">
          ...
          <el-col :span="9" class="table_td">
            <el-col :span="14" :offset="1">
              <el-input disabled size="small" disabled v-model="item.workYear" @blur="verify(item.workYear,8,index)" placeholder="输入整数的年份"></el-input>
            </el-col>
        ...
        <el-col :span="24" class="table_tr">
          ...
          <el-col :span="18" class="table_td bmp_selectleft idcart">
            <el-select disabled v-model="item.liveshen" @change="liveCode" size="small" class="allSe" placeholder="省">
              <el-option v-for="data in provinceListVoList" :value="data.provinceCode" :label="data.provinceName" :key="data.provinceCode"></el-option>
            </el-select>
            <el-select disabled v-model="item.liveshi" @change="livegetare" size="small" class="allSe" placeholder="市">
              <el-option v-for="data in livecityListVoList" :value="data.cityCode" :label="data.cityName" :key="data.cityCode"></el-option>
            </el-select>
            <el-select disabled v-model="item.residentAddressCode" size="small" class="allSe" placeholder="区">
      ...
      <picModule :bussNo="$route.query.bussNo" dataType="2" taskType="136" :custId="item.releId" class="module_margin_bottom" :details="false"/>
    ...
    methods: {
      ...
      verify(data, type, index, data1, data2) {
        switch (type) {
          ...
          case 11:
            if (!data1) {
              if (this._utils.isNumber(data) || data == '') {
      ...
      save(item, index) {
        ...
        for (let i = 0; i < this.borrowerPersonList.length; i++) {
          if (!this.borrowerBolList[i].isErrorBrower && !this.borrowerBolList[i].certNo && !this.borrowerBolList[i].certName && !this.borrowerBolList[i].workUnit && !this.borrowerBolList[i].properties && !this.borrowerBolList[i].occupation && this.borrowerBolList[i].unitIndustry) {
            window.bus.isFullLoan = '1'
          } else {
            window.bus.isFullLoan = '0'
          }
